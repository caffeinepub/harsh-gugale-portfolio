  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "deep-navy": "#060b18",
        "mid-navy": "#0a1128",
        "surface-01": "rgba(255,255,255,0.03)",
      },
      fontFamily: {
        ...
        mono: ['"SF Mono"', '"Fira Code"', '"Cascadia Code"', '"Consolas"', "ui-monospace", "monospace"],
      ...
      boxShadow: {
        ...
        "neon-purple": "0 0 20px rgba(123,47,255,0.4), 0 0 40px rgba(123,47,255,0.15)",
