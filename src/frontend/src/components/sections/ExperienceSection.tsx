    ...
    >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          >
            DEPLOYMENT HISTORY :: 2 ENTRIES FOUND
          </p>
        </div>
            ...
            {experiences.map((exp, idx) => (
              ...
              >
                ...
                <div className="flex-1">
                  <div
                    className={`${exp.cardClass} rounded-lg p-6 relative overflow-hidden`}
                    style={{
                      maxWidth: "440px",
                ...
                <div className="hidden md:flex items-start justify-center pt-6 relative z-10 w-8 flex-shrink-0">
                  <div
                    className={`w-4 h-4 rounded-full ${exp.nodePulse}`}
                    style={{
                      backgroundColor: exp.nodeColor,
                      border: `2px solid ${exp.nodeColor}`,
                    }}
                  />
                </div>
